...
function csere() {
    with (document.f) {
        ...
        data2.value = tmp;
        tmp = nep1.value;
        nep1.value = nep2.value;
        nep2.value = tmp;
        tmp = kor1.value;
        kor1.value = kor2.value;
        kor2.value = tmp;
        tmp = terulet1.value;
        terulet1.value = terulet2.value;
        terulet2.value = tmp;
        tmp = pont1.value;
        pont1.value = pont2.value;
        pont2.value = tmp;
        tmp = moral1.value;
        moral1.value = moral2.value;
        moral2.value = tmp;
        tmp = deka1.value;
        deka1.value = deka2.value;
        deka2.value = tmp;
        tmp = tudi1.value;
        tudi1.value = tudi2.value;
        tudi2.value = tmp;
        tmp = vari1.checked;
        vari1.checked = vari2.checked;
        vari2.checked = tmp;
        tmp = bator1.checked;
        bator1.checked = bator2.checked;
        bator2.checked = tmp;
        tmp = allam1.value;
        allam1.value = allam2.value;
        allam2.value = tmp;
        tmp = bonusz1.value;
        bonusz1.value = bonusz2.value;
        bonusz2.value = tmp;
        tmp = elhullas.value;
        elhullas.value = elhullas2.value;
        elhullas2.value = tmp;

        tmp = gyalog1.value;
        gyalog1.value = gyalog2.value;
        gyalog2.value = tmp;
        tmp = vedo1.value;
        vedo1.value = vedo2.value;
        vedo2.value = tmp;
        tmp = tamado1.value;
        tamado1.value = tamado2.value;
        tamado2.value = tmp;
        tmp = ostrom1.value;
        ostrom1.value = ostrom2.value;
        ostrom2.value = tmp;
        tmp = evedo1.value;
        evedo1.value = evedo2.value;
        evedo2.value = tmp;
        tmp = etamado1.value;
        etamado1.value = etamado2.value;
        etamado2.value = tmp;

        tmp = gyalog1r.value;
        gyalog1r.value = gyalog2r.value;
        gyalog2r.value = tmp;
        tmp = vedo1r.value;
        vedo1r.value = vedo2r.value;
        vedo2r.value = tmp;
        tmp = tamado1r.value;
        tamado1r.value = tamado2r.value;
        tamado2r.value = tmp;
        tmp = ostrom1r.value;
        ostrom1r.value = ostrom2r.value;
        ostrom2r.value = tmp;
        tmp = evedo1r.value;
        evedo1r.value = evedo2r.value;
        evedo2r.value = tmp;
        tmp = etamado1r.value;
        etamado1r.value = etamado2r.value;
        etamado2r.value = tmp;
...
function find(ebben, ezt) //csak teljes szot keres
{
    ...
    while (1) {
        ...
        if (idx == -1) return -1;
//    	  alert(ebben + "\n" + ezt + "\n" + idx + "\n" + ebben.charAt(idx-1));
        if (idx != 0 && !issp(ebben.charAt(idx - 1))) {
            idx++;
            continue;
        }
        if (idx + ezt.length == ebben.length && !issp(ebben.charAt(idx + ezt.length))) {
            idx++;
            continue;
        }
        return idx;
